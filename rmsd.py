...
def is_equal(img_actual,img_expected,result):
    ...
    if os.path.exists(img_actual) and os.path.exists(img_expected):
        ...
        result_image = ImageChops.difference(actual.convert('CMYK'),expected.convert('RGBA'))
...
if __name__=='__main__':
    ...
    img1 = r'C:\Users\user\PycharmProjects\imgCompare\Cookie\cookie0.png'
    img2 = r'C:\Users\user\PycharmProjects\imgCompare\Cookie\cookie1.png'
    result_img= r'C:\Users\user\PycharmProjects\imgCompare\Cookie\test.JPEG' #please add path along with resultant image name which you want
